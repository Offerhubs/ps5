...
function SS2() {
    ...
    if (NAME && EMAIL && REGION) {
        ...
        $(".STEP-2").fadeOut(1000, function() {
            ...
            var TO1 = {
                strings: [
                    "Checking if there are any <strong>new PlayStation 5 Slim test consoles</strong> left in <strong>" + REGION + "</strong>...^2000",
                    "Showing available <strong>new PlayStation 5 Slim consoles</strong> for <strong>" + REGION + "</strong> region...^1000",
                    "Choose your <strong>PlayStation 5 Slim console</strong>...^1000"
                ],
                typeSpeed: 50,
                backSpeed: 40,
                startDelay: 500,
...
function SS3() {
    ...
    $(".STEP-3").fadeOut(1000, function() {
        ...
        if (MOBILE) {
            $("body").attr("style", "background-image: url(mobile-bg.jpg); padding-bottom: 25% !important;");
        }
        ...
        var TO2 = {
            strings: [
                "Reserving your <strong>PlayStation 5 Slim " + VERSION + "</strong>...^3000",
